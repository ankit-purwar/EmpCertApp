app.controller('employeeMasterController', ['$scope', '$location', 'networkService', 'localStorageService', '$rootScope', function ($scope, $location, networkService, localStorageService, $rootScope) {
